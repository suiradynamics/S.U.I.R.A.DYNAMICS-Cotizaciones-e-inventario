...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-6 lg:p-24 bg-gray-50">
      ...
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-gray-100 space-y-8 my-8">
        {error && (
        ...
        <button
          ...
          type="button"
          className="w-full py-2.5 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white"
        >
          Continuar con Google
        </button>

        <div className="pt-6 border-t border-gray-200">
          <h3 className="text-lg font-bold text-gray-900 text-center">¿No tienes cuenta?</h3>
          <form onSubmit={handleRegister} className="space-y-4 mt-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-gray-900 text-white font-semibold rounded-lg text-sm"
            >
